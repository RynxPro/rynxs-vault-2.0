          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="col-span-1 md:col-span-2">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <h3 className="text-xl font-bold text-gray-900">Rynx&apos;s Vault</h3>
                  <p className="text-gray-600 text-sm">Your Gaming Sanctuary</p>
                </div>
              </div>
              <p className="text-gray-700 leading-relaxed max-w-md">
                Discover, share, and celebrate the best indie games. Connect with developers, 
                explore new worlds, and be part of a thriving gaming community.
              </p>
            </div>
