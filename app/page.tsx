...
function GameGridSkeleton() {
  return (
    <div className="grid md:grid-cols-3 sm:grid-cols-2 gap-6" role="status" aria-label="Loading games">
    ...
    <div className="col-span-full text-center py-16">
      <div className="max-w-md mx-auto">
        ...
        <p className="text-gray-600 mb-6">
          {query ? "Try adjusting your search terms or browse all games" : "Be the first to share your game with the community!"}
        </p>
        {!query && (
          <Link 
            href="/game/upload" 
  ...
  return (
    <>
      ...
      <section className="relative w-full bg-gradient-to-br from-background via-accent to-background min-h-[530px] flex justify-center items-center flex-col py-16 px-6 overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-primary-50/30 via-transparent to-accent/30" aria-hidden="true"></div>
        
        {/* Floating elements */}
        <div className="absolute top-20 left-10 w-20 h-20 bg-primary-200/20 rounded-full blur-xl animate-pulse" aria-hidden="true"></div>
        <div className="absolute bottom-20 right-10 w-32 h-32 bg-accent/30 rounded-full blur-xl animate-pulse delay-1000" aria-hidden="true"></div>
        
        <div className="relative z-10 text-center">
          <div className="slide-up">
            <h1 className="text-4xl sm:text-6xl font-bold tracking-tight text-foreground text-center my-6 bg-gradient-to-r from-foreground to-primary-600 bg-clip-text text-transparent mb-6">
              Share Your <span className="bg-gradient-to-r from-primary-600 to-primary-800 bg-clip-text text-transparent">Games</span>, <br />
      ...
      <section className="px-6 py-10 max-w-7xl mx-auto">
        <div className="slide-up">
          ...
          <p className="text-gray-600 mb-8">
            {query ? `Found ${posts.length} games matching your search` : "Explore the latest creations from our community"}
          </p>
        </div>

        <Suspense fallback={<GameGridSkeleton />}>
          <div className="fade-in">
            <ul className="grid md:grid-cols-3 sm:grid-cols-2 gap-6" role="list">
              {posts?.length > 0 ? (
